...
function defaultSettings() {
  return {
    ...
    weeklyReminderText: 'כדאי להקדים! 🌿 הזמנות שמגיעות מוקדם בשבוע מקבלות את מבחר התוצרת המלא והטרי ביותר. בסוף השבוע ההזמנות מסופקות על בסיס המלאי הקיים בלבד — אז נשמח לראותכם מזמינים מוקדם בשבוע הבא.',

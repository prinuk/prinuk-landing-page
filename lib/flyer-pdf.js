...
function buildFlyerHtml(catalog) {
  ...
  return [
    ...
    '.category-box{border:1px solid #d9cdaa;border-radius:12px;background:#fffdf8;margin:0 0 10px;break-inside:avoid;}',
    '.category-title{margin:0;padding:8px 10px;text-align:center;color:#fff;font-size:21px;font-weight:900;}',
